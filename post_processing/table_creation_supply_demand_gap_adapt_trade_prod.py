...
# ---  Paths ---
folder_path = "../simulation/output/adapt_trade_prod/"
...
ssp126_summary_df.to_csv("output/ssp126_summary_data_adapt_trade_prod.csv", index=False)
ssp585_summary_df.to_csv("output/ssp585_summary_data_adapt_trade_prod.csv", index=False)